...
function HomePage() {
  ...
  useGSAP(() => {
    const titles = gsap.utils.toArray("#wrapper > .box");
    const loop = horizontalLoop(titles, { repeat: -1,speed: .8 });

    const boxes = gsap.utils.toArray("#footer-wrapper > .box");
    const bottomLoop = horizontalLoop(boxes, {
      repeat: -1,
      reversed: true,
      paused: true,
      speed: .8
    ...
    <>
      <div id="wrapper" className={styles.wrapper}>
        <div className={`${styles.title} box`}>
          <div className={styles.bannerParallelogram_1}></div>
          <div className={styles.bannerParallelogram_2}></div>
          <svg
          ...
          <div className={styles.bannerParallelogram_3}></div>
          <div className={styles.bannerParallelogram_4}></div>
        </div>
        <div className={`${styles.title} box`}>
          <div className={styles.bannerParallelogram_1}></div>
          <div className={styles.bannerParallelogram_2}></div>
